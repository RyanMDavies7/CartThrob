<?php
/**
 * Cardstream payment module for CartThrob 3
 *
 ...
 * @package default
 * @author Cardstream <https://www.cardstream.com>
 * @version 1.0
 */
class Cartthrob_cardstream_hosted extends Cartthrob_payment_gateway
{
  public $title = 'cardstream_title';
  public $overview = 'cardstream_description';
   ...
   * @author Cardstream <https://www.cardstream.com>
   ...
   public function charge($credit_card_number){
     ...
     $post_array = array(
       ...
       'redirectURL' => $this->response_script(ucfirst(get_class($this)), array("cardstreamResponse")),
